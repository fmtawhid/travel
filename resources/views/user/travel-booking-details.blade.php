				...
				<div class="db-2-main-com db-2-main-com-table">
					...
					<div class="db-mak-pay-bot" style="margin-top: 30px; background-color: #f8f9fa; padding: 20px; border-radius: 8px; border-left: 5px solid #667eea;">
						...
						<div style="margin-top: 15px; display: flex; gap: 10px;">
							<a href="{{ route('user.payment.view', ['tour', $booking->id]) }}" class="waves-effect waves-light btn-large" style="background-color: #43e97b; flex: 1; text-align: center; display: inline-block;">View Payment</a>
