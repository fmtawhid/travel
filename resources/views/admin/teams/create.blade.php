                    ...
                    <div id="menu1" class="tab-pane fade">
                        <div class="box-inn-sp">
                            ...
                            <div class="bor">
                                <div class="row">
                                    <div class="input-field col s12">
                                        <input name="facebook" type="url" class="validate" value="{{ old('facebook') }}" 
                                    ...
                                    <div class="input-field col s12">
                                        <input name="instagram" type="url" class="validate" value="{{ old('instagram') }}"
                                    ...
                                    <div class="input-field col s12">
                                        <input name="twitter" type="url" class="validate" value="{{ old('twitter') }}"
                                    ...
                                    <div class="input-field col s12">
                                        <input name="linkedin" type="url" class="validate" value="{{ old('linkedin') }}"
                                    ...
                                    <div class="input-field col s12">
                                        <input name="youtube" type="url" class="validate" value="{{ old('youtube') }}"
