                ...
                <div class="row">
                    ...
                    <div class="input-field col s12">
                        <select id="booking_type" required onchange="updateBookingSelect(this.value)">
                            ...
                            <option value="tour" {{ request('booking_type') == 'tour' ? 'selected' : '' }}>Tour Booking</option>
                            <option value="hotel" {{ request('booking_type') == 'hotel' ? 'selected' : '' }}>Hotel Booking</option>
                            <option value="car" {{ request('booking_type') == 'car' ? 'selected' : '' }}>Car Booking</option>
                            <option value="flight" {{ request('booking_type') == 'flight' ? 'selected' : '' }}>Flight Booking</option>
                            <option value="custom" {{ request('booking_type') == 'custom' ? 'selected' : '' }}>Custom Booking</option>
                        </select>
                    ...
                    <div class="input-field col s12" id="tour_booking_group" style="display:none;">
                        <select name="tour_booking_id" id="tour_booking_id">
                            ...
                            @foreach($tourBookings as $booking)
                                <option value="{{ $booking->id }}" {{ request('booking_id') == $booking->id && request('booking_type') == 'tour' ? 'selected' : '' }}>
                                    Tour #{{ $booking->id }} - {{ $booking->name }} - {{ $booking->min_price }} to {{ $booking->max_price }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-field col s12" id="hotel_booking_group" style="display:none;">
                        <select name="hotel_booking_id" id="hotel_booking_id">
                            ...
                            @foreach($hotelBookings as $booking)
                                <option value="{{ $booking->id }}" {{ request('booking_id') == $booking->id && request('booking_type') == 'hotel' ? 'selected' : '' }}>
                                    Hotel #{{ $booking->id }} - {{ $booking->name }} - {{ $booking->min_price }} to {{ $booking->max_price }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-field col s12" id="car_booking_group" style="display:none;">
                        <select name="car_booking_id" id="car_booking_id">
                            ...
                            @foreach($carBookings as $booking)
                                <option value="{{ $booking->id }}" {{ request('booking_id') == $booking->id && request('booking_type') == 'car' ? 'selected' : '' }}>
                                    Car #{{ $booking->id }} - {{ $booking->name }} - {{ $booking->min_price }} to {{ $booking->max_price }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-field col s12" id="flight_booking_group" style="display:none;">
                        <select name="flight_booking_id" id="flight_booking_id">
                            ...
                            @foreach($flightBookings as $booking)
                                ...
                                <option value="{{ $booking->id }}" {{ request('booking_id') == $booking->id && request('booking_type') == 'flight' ? 'selected' : '' }}>
                                    Flight #{{ $booking->id }} - {{ $booking->name }} - {{ $booking->min_price }} to {{ $booking->max_price }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-field col s12" id="custom_booking_group" style="display:none;">
                        <select name="custom_booking_id" id="custom_booking_id">
                            ...
                            @foreach($customBookings as $booking)
                                <option value="{{ $booking->id }}" {{ request('booking_id') == $booking->id && request('booking_type') == 'custom' ? 'selected' : '' }}>
                                    Custom #{{ $booking->id }} - {{ $booking->name }} - {{ $booking->min_price }} to {{ $booking->max_price }}
                                </option>
                            @endforeach
                        </select>
