		...
		<div class="rows inner_banner inner_banner_2">
			<div class="container">
				<div class="spe-title tit-inn-pg">
					...
					<p>{{ $hotel->description ?? 'World\'s leading Hotel Booking website, Over 30,000 Hotel rooms worldwide.' }}</p>
					<ul>
						<li><a href="{{ route('main') }}">Home</a></li>
						<li><i class="fa fa-angle-right" aria-hidden="true"></i> </li>
						<li><a href="#" class="bread-acti">{{ $hotel->name }}</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="container">
				<div class="banner_book_1">
					<ul>
						...
						<li class="dl4"><a href="#">Contact Hotel</a> </li>
					</ul>
				</div>
			</div>
		</div>
	...
	<section>
		<div class="rows inn-page-bg com-colo">
			<div class="container inn-page-con-bg tb-space">
				...
				<!--====== HOTEL TITLE ==========-->
				<div class="tour_head">
					<h2>{{ $hotel->name }} <span class="tour_star"><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star" aria-hidden="true"></i><i class="fa fa-star-half-o" aria-hidden="true"></i></span><span class="tour_rat">4.5</span></h2> </div>
					<!--====== TOUR DESCRIPTION ==========-->
					<div class="tour_head1 hotel-com-color">
						<h3>About {{ $hotel->name }}</h3>
						<p>{{ $hotel->description ?? 'Hotel description not available.' }}</p>
					</div>
					<!--====== ROOMS: HOTEL BOOKING ==========-->
					<div class="tour_head1 hotel-book-room">
						...
						<div id="myCarousel1" class="carousel slide" data-ride="carousel">
							...
							<ol class="carousel-indicators carousel-indicators-1">
								...
								<li data-target="#myCarousel1" data-slide-to="1"><img src="images/gallery/s2.jpeg" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="2"><img src="images/gallery/s3.jpeg" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="3"><img src="images/gallery/s4.jpeg" alt="Chania">
								</li>
								<li data-target="#myCarousel1" data-slide-to="4"><img src="images/gallery/s5.jpeg" alt="Chania">
								</li>
							...
							<div class="carousel-inner carousel-inner1" role="listbox">
								...
								<div class="item"> <img src="images/gallery/s2.jpeg" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="images/gallery/s3.jpeg" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="images/gallery/s4.jpeg" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="images/gallery/s5.jpeg" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="images/gallery/s6.jpeg" alt="Chania" width="460" height="345"> </div>
								<div class="item"> <img src="images/gallery/s7.jpeg" alt="Chania" width="460" height="345"> </div>
					...
					<div class="tour_head1">
						...
						<div class="tr-room-type">
							<ul>
								...
								<li>
									<div class="tr-room-type-list">
										<div class="col-md-3 tr-room-type-list-1"><img src="images/rooms/02.jpeg" alt="" />
										</div>
										<div class="col-md-6 tr-room-type-list-2">
								...
								<li>
									<div class="tr-room-type-list">
										<div class="col-md-3 tr-room-type-list-1"><img src="images/rooms/03.jpeg" alt="" />
										</div>
										<div class="col-md-6 tr-room-type-list-2">
								...
								<li>
									<div class="tr-room-type-list">
										<div class="col-md-3 tr-room-type-list-1"><img src="images/rooms/04.jpeg" alt="" />
										</div>
										<div class="col-md-6 tr-room-type-list-2">
											<h4>Normal Rooms</h4>
											<p><b>Amenities: </b>Television, Wi-Fi, Hair dryer, Towels, Dining, Music, GYM and more.. </p> <span><b>Includes</b> : Free Parking, Breakfast, VAT</span> <span><b>Maxinum </b> : 4 Persons</span> </div>
