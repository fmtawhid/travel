		...
		<div class="v2-hom-search">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6">
					<div class="">
						<form class="contact__form v2-search-form book-tab-form" method="post" action="mail/hotelbooking.php">
							...
							<div class="row">
								<div class="input-field col s12">
									<select name="city" class="chosen-select" id="city">
										<option value="" disabled selected>City, Destination and Hotel Name</option>
							...
							<div class="row">
								<div class="input-field col s6">
									<input type="text" class="datepicker" name="checkin" placeholder="Check In" readonly>
								</div>
								<div class="input-field col s6">
									<input type="text"  class="datepicker" name="checkout" placeholder="Check Out" readonly>
								</div>
							</div>
							<div class="row">
								<div class="input-field col s6">
									<select class="chosen-select" name="noofrooms">
								...
								<div class="input-field col s6">
									<select class="chosen-select" name="roomtype">
